...
main_headers = [
    'Total', 'Illiterate', 'Literate but no diploma',
    'Primary School', 'Secondary School', 'Middle School or Equivalent', 'High School or Equivalent',
    'Higher Education', 'Master's Degree', 'Doctorate', 'Unknown'
]
sub_headers = ['Total', 'Male', 'Female']
